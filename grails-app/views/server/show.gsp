            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="server.entries.label" default="Entries" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${serverInstance.entries}" var="e">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="server.leagues.label" default="Leagues" /></td>
