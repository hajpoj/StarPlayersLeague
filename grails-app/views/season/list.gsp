                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'season.id.label', default: 'Id')}" />
                    ...
                    <g:each in="${seasonInstanceList}" status="i" var="seasonInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${seasonInstance.id}">${fieldValue(bean: seasonInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: seasonInstance, field: "name")}</td>
