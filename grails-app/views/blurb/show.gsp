                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:blurbInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:blurbInstance, field:'name')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${blurbInstance.content}</td>
