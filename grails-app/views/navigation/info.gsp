<html>
	...
	<body>
		<div class="mcontent">
			...
			<div class="break"></div>
			<h2>1v1 League Format & Rules</h2>
			<div class="break"></div>
			<p class="note">Layout</p>
			<br/>
			<ul class="normal">
			...
			<br/>
			<ul class="normal">
				<li>Winners report match results.</li>
			...
			<br/>
			<ul class="normal">
				<li>Players are ranked by the number of match wins.</li>
				<li>If players are tied in rank, the tie-breaker is game differential.</li>
			</ul>
			<br/>
			...
			<ul class="normal">
				...
				<li>Cheating or dishonesty will result in an immediate and permanent ban.</li>
