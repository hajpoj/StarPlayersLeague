            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="group.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: groupInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="group.division.label" default="Division" /></td>
                            
                            <td valign="top" class="value"><g:link controller="division" action="show" id="${groupInstance?.division?.id}">${groupInstance?.division?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="group.entries.label" default="Entries" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="group.matches.label" default="Matches" /></td>
