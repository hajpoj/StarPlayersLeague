                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="matches"><g:message code="registration.matches.label" default="Matches" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: registrationInstance, field: 'matches', 'errors')}">
                                    <g:select name="matches" from="${spl.Match.list()}" multiple="yes" optionKey="id" size="5" value="${registrationInstance?.matches*.id}" />
                                </td>
                            </tr>
